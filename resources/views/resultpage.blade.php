...
<div class="jumbotron text-center">
        <h1 class="text-center"><span class="badge badge-secondary">@foreach($name as $t)
      {{$t->book_name}}
    @endforeach </span></h1>
</div>
...
<!--       <h3 class="text-center">Book's ID. {{$id}}</h3> -->
      <p class="text-center">@foreach($Des0 as $t)
      {{$t->book_abstract}}
    @endforeach</p>
        </div>
...
<div class="jumbotron text-center">
  <h1 class="text-center"><span class="badge badge-secondary">Recommendation </span></h1>
    <p>   </p>
  <div class="container">
  <div class="row">
    ...
    <div class="col-sm-4"  style="text-align:center">
      ...
      <button id="btn1"class="btn btn-light" ><i class="fa fa-book"></i>{{$id2[0]}}</button>
        <img id="img0" src="https://www.w3cschool.cn/attachments/image/20180524/1527144620597215.png" class="img-fluid">
    ...
    <div class="col-sm-4"  style="text-align:center">
      <button id="btn2" class="btn btn-light"><i class="fa fa-book"></i>{{$id2[1]}}</button>
    ...
    <div class="col-sm-4"  style="text-align:center">
      <button id="btn3" class="btn btn-light" ><i class="fa fa-book"></i>{{$id2[2]}}</button>
